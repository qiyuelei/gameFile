...
{
    [self initializePlat];
    NSString *_message = [[NSString alloc]initWithString:[NSString stringWithFormat:NSLocalizedString(@"I have %i points, more than you!#Pet Collapse#https://itunes.apple.com/us/app/pet-collapse-hd/id733242821?ls=1&mt=8",nil),bestScore]];
    NSString *_title = NSLocalizedString(@"Pet Collapse", nil);
    //NSLog(@"fasdf:%@",_message);
    //创建分享内容
    NSString *imagePath = [[NSBundle mainBundle] pathForResource:IMAGE_NAME ofType:IMAGE_EXT];
    id<ISSContent> publishContent = [ShareSDK content:_message
                                       defaultContent:@""
                                                image:[ShareSDK imageWithPath:imagePath]
                                                title:_title
                                                  url:@"https://itunes.apple.com/us/app/pet-collapse-hd/id733242821?ls=1&mt=8"
                                          description:nil
...
- (void)initializePlat
{
    [ShareSDK registerApp:@"ae18c3045b0"];
    //[self initializePlat];
    
    //添加微信应用  //long
       [ShareSDK connectWeChatWithAppId:@"wx78003feeeaec6337"
