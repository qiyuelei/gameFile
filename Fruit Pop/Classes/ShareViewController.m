...
{
    [self initializePlat];
    NSString *_message = [[NSString alloc]initWithString:[NSString stringWithFormat:NSLocalizedString(@"I have %i points, more than you!",nil),bestScore]];
    NSString *_title = NSLocalizedString(@"The Fruit Pop", nil);
    ...
    id<ISSContent> publishContent = [ShareSDK content:_message
                                       defaultContent:@""
                                                ...
                                                title:_title
                                                  url:@"https://itunes.apple.com/us/app/the-fruit-pop/id725961876?ls=1&mt=8"
                                          description:nil
