...
{
    [self initializePlat];
    NSString *_message = [[NSString alloc]initWithString:[NSString stringWithFormat:NSLocalizedString(@"I have %i points, more than you!#Pet Collapse#https://itunes.apple.com/us/app/pet-collapse/id731781280?ls=1&mt=8",nil),bestScore]];
    ...
    id<ISSContent> publishContent = [ShareSDK content:_message
                                       defaultContent:@""
                                                ...
                                                title:_title
                                                  url:@"https://itunes.apple.com/us/app/pet-collapse/id731781280?ls=1&mt=8"
                                          description:nil
